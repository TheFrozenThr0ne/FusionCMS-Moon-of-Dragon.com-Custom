											...
											<form id="form-general-settings" class="mx-auto min-w-lg max-w-lg space-y-12 py-8">
												...
												<fieldset class="relative">
													...
													<div class="grid grid-cols-12 gap-4">
														<div class="col-span-12">
															<div class="group/nui-input relative">
																<select id="cdn" class="nui-focus border-muted-300 text-muted-600 placeholder:text-muted-300 focus:border-muted-300 focus:shadow-muted-300/50 dark:border-muted-700 dark:bg-muted-900/75 dark:text-muted-200 dark:placeholder:text-muted-500 dark:focus:border-muted-700 dark:focus:shadow-muted-800/50 peer/input relative w-full border bg-white pe-12 ps-4 font-sans text-sm leading-5 focus:shadow-lg disabled:cursor-not-allowed disabled:opacity-75 rounded-xl">
